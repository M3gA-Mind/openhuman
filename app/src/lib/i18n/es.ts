...
const messages: TranslationMap = {
  ...
  'settings.persona.builder.intro': 'Rellena unos campos y los escribimos en tu persona por ti. No hace falta markdown.',
  'settings.persona.builder.personalityLabel': 'Personalidad',
  'settings.persona.builder.personalityPlaceholder': 'p. ej. Cercano, curioso y directo. Honesto ante la incertidumbre.',
  'settings.persona.builder.voiceLabel': 'Estilo de comunicación',
  'settings.persona.builder.voicePlaceholder': 'p. ej. Empieza por la respuesta, sé breve y adapta mi tono.',
  'settings.persona.builder.aboutLabel': 'Sobre ti',
  'settings.persona.builder.aboutPlaceholder': 'p. ej. Dirijo un pequeño estudio de diseño y prefiero un lenguaje sencillo.',
  'settings.persona.builder.preservedNote': 'Cualquier otra sección que hayas escrito a mano se conserva: cambia a Avanzado para ver la persona completa.',
