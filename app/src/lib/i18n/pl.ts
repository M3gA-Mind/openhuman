...
const messages: TranslationMap = {
  ...
  'agentWorld.transferHandle.action': 'Przenieś',
  'agentWorld.transferHandle.title': 'Przenieś handle',
  'agentWorld.transferHandle.warning':
    'Przeniesienie handle jest trwałe i nie można go cofnąć. Odbiorca staje się jego jedynym właścicielem.',
  'agentWorld.transferHandle.recipientPlaceholder': '@handle odbiorcy',
  'agentWorld.transferHandle.confirm': 'Przenieś handle',
  'agentWorld.transferHandle.submitting': 'Przenoszenie…',
