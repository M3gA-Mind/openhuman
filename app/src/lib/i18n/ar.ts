...
const messages: TranslationMap = {
  ...
  'settings.persona.builder.intro': 'املأ بضعة حقول وسنكتبها في شخصيتك نيابةً عنك. لا حاجة إلى ماركداون.',
  'settings.persona.builder.personalityLabel': 'الشخصية',
  'settings.persona.builder.personalityPlaceholder': 'مثال: ودود وفضولي ومباشر. صادق عند عدم اليقين.',
  ...
  'settings.persona.builder.aboutPlaceholder': 'مثال: أدير استوديو تصميم صغيرًا وأفضّل اللغة البسيطة.',
  'settings.persona.builder.preservedNote': 'تُحفظ أي أقسام أخرى كتبتها بنفسك — انتقل إلى «متقدّم» لرؤية الشخصية كاملة.',
