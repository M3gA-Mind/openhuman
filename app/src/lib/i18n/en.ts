...
const en: TranslationMap = {
  ...
  'rewards.community.discordLinkedNotInGuild': 'Discord linked not in guild',
  'rewards.community.discordMember': 'Joined the server',
  'rewards.community.discordNotLinked': 'Discord not linked',
  'rewards.community.discordServer': 'Discord server',
  'rewards.community.discordStatusUnavailable': 'Discord status unavailable',
  'rewards.community.discordWaiting': 'Discord waiting',
