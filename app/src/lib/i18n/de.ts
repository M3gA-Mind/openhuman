...
const messages: TranslationMap = {
  ...
  'share.privacyNote': 'Geteilt werden nur diese Überschrift, die Bildunterschrift und das Branding. Dein Chat, dein Gedächtnis und deine Dateien bleiben privat.',
